...
import com.yuk.hyperOS_XXL.utils.KotlinXposedHelper.callMethodOrNull
...
object ShowMoreApkInfo : BaseHook() {
    ...
    override fun init() {
        ...
        mApkInfo = "com.miui.packageInstaller.model.ApkInfo".findClassOrNull()
        ...
        if (mAppInfoViewObject != null) {
            mAppInfoViewObjectViewHolder = "com.miui.packageInstaller.ui.listcomponets.AppInfoViewObject\$ViewHolder".findClassOrNull()
            val methods: Array<Method> = XposedHelpers.findMethodsByExactParameters(mAppInfoViewObject, Void.TYPE, mAppInfoViewObjectViewHolder)
            if (methods.isNotEmpty()) {
                ...
                methods[0].hookAfterMethod { hookParam ->
                    ...
                    if (mAppInfo != null) {
                        mAppVersionName = apkInfo.callMethod("getInstalledVersionName") as String + " ➟ " + mPkgInfo.versionName
                        mAppVersionCode = apkInfo.callMethod("getInstalledVersionCode").toString() + " ➟ " + mPkgInfo.longVersionCode
                        mAppSdk =
                    ...
                    mAppSizeView.text = moduleRes.getString(R.string.packageinstaller_app_size_title) + ": " + mOldAppSize + mNewAppSize
