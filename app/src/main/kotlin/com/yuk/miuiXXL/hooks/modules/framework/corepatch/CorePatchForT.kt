...
open class CorePatchForT : CorePatchHelper(), IXposedHookLoadPackage, IXposedHookZygoteInit {
    override fun handleLoadPackage(loadPackageParam: XC_LoadPackage.LoadPackageParam) {
                                    ...
                                    val lastCerts: Array<Array<Certificate>> =
                                        if (parseErr != null) {
                                            XposedHelpers.callMethod(
                                                XposedHelpers.callStaticMethod(ASV, "loadCertificates", methodHookParam.args[0], origJarFile, manifestEntry),
                                                "getResult"
        ...
        findAndHookMethod("android.content.pm.ApplicationInfo", loadPackageParam.classLoader, "isPackageWhitelistedForHiddenApis",
            object : XC_MethodHook() {
                override fun beforeHookedMethod(param: MethodHookParam) {
        ...
        if (keySetManagerClass != null) {
            ...
            hookAllMethods(keySetManagerClass, "shouldCheckUpgradeKeySetLocked",
                object : XC_MethodHook() {
            ...
            hookAllMethods(keySetManagerClass, "checkUpgradeKeySetLocked",
                object : XC_MethodHook() {
                    override fun afterHookedMethod(param: MethodHookParam) {
